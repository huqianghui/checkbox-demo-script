...
parser.add_argument("--files", help="Files to be processed",default='/Users/huqianghui/Downloads/1.Enterprise-internal-KB/outlook-demo-script/checkbox/H2_AN202208221577459815_1-8.pdf')
...
parser.add_argument("--index", help="Name of the Azure Cognitive Search index where content should be indexed (will be created if it doesn't exist)",default="checkboxindex")
...
def get_document_text(filename):
    ...
    if args.localpdfparser:
        ...
        print("pages: \n" + str(form_recognizer_results.pages))

        for page_num, page in enumerate(form_recognizer_results.pages):

            # tables on page process,因为tables属于整个document，需要识别出来当前page的tables
...
# 因为在layout中，checkbox和label没有很好的对应关系，所以只能根据文本规则来判断（checkbox所以在位置，到换行或者空格为分界线）
